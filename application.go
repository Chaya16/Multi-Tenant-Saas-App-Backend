...
func (oc OrderController) CreateOrder(w http.ResponseWriter, r *http.Request) {
	...
	var links Links
	links.Payment = "http://cloudbucks.herokuapp.com/v1/starbucks/store3/order/" + o.OrderId + "/pay"
	links.Order = "http://cloudbucks.herokuapp.com/v1/starbucks/store3/order/" + o.OrderId
